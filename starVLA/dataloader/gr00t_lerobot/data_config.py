...
class SingleFrankaRobotiqDeltaEefDataConfig:
    video_keys = [
        "video.rgb_base_view",
        "video.rgb_base_view_2",
        "video.rgb_ego_view",
    ]
    state_keys = [
        "state.effector_position",
        "state.effector_orientation",
    ]
    action_keys = [
        "action.effector_delta_position",
        "action.effector_delta_orientation",
        "action.gripper_position",
    ]
    ...
    def transform(self):
        transforms = [
            ...
            StateActionTransform(
                apply_to=self.state_keys,
                normalization_modes={
                    "state.effector_position": "min_max",
                    "state.effector_orientation": "min_max",
                },
            ),
            # action transforms
            StateActionToTensor(apply_to=self.action_keys),
            StateActionTransform(
                apply_to=self.action_keys,
                normalization_modes={
                    "action.effector_delta_position": "min_max",
                    "action.effector_delta_orientation": "min_max",
                    "action.gripper_position": "binary",
                },
            ),
        ]
...
class AgilexDualArmDeltaEefDataConfig:
    video_keys = [
        "video.top_view",
        "video.left_view",
        "video.right_view",
...
class H10WDualArmEefDataConfig:
    video_keys = [
        "video.primary_image",
        "video.left_camera_image",
        "video.right_camera_image",
    ]
    state_keys = [
    ...
    def transform(self):
        transforms = [
            ...
            StateActionTransform(
                apply_to=self.state_keys,
                normalization_modes={
                    "state.observation_state": "min_max",
                },
            ),
            # action transforms
            StateActionToTensor(apply_to=self.action_keys),
...
class H10WDualArmJointDataConfig:
    video_keys = [
        "video.primary_image",
        "video.left_camera_image",
        "video.right_camera_image",
...
class H10WRealDualArmJointDataConfig:
    video_keys = [
        "video.primary_image",
        "video.left_camera_image",
        "video.right_camera_image",
    ...
    state_keys = [
        "state.left_observation_state",
        "state.left_gripper_state",
        "state.right_observation_state",
        "state.right_gripper_state",
    ]
    action_keys = [
        "action.left_joint_action",
        "action.left_gripper",
        "action.right_joint_action",
    ...
    def transform(self):
        transforms = [
            ...
            StateActionTransform(
                apply_to=self.state_keys,
                normalization_modes={
                    "state.left_observation_state": "min_max",
                    "state.left_gripper_state": "min_max",
                    "state.right_observation_state": "min_max",
                    "state.right_gripper_state": "min_max",
                },
            ),
            # action transforms
            StateActionToTensor(apply_to=self.action_keys),
            StateActionTransform(
                apply_to=self.action_keys,
                normalization_modes={
                    "action.left_joint_action": "min_max",
                    "action.left_gripper": "min_max",
                    "action.right_joint_action": "min_max",
                    "action.right_gripper": "min_max",
                    #"action.done_flag": "binary",
                },
            ),
        ]
...
class H10WRealDualArmJointDataConfigChunk32(H10WRealDualArmJointDataConfig):
...
class Libero4in1DataConfig:
    ...
    def transform(self):
        transforms = [
            ...
            apply_to=self.action_keys,
            normalization_modes={
                "action.action": "min_max",#"action.x": "min_max",
                # "action.y": "min_max",
                # "action.z": "min_max",
                # "action.roll": "min_max",
...
ROBOT_TYPE_CONFIG_MAP = {
    ...
    "demo_sim_franka_delta_eef": SingleFrankaRobotiqDeltaEefDataConfig(),
    "custom_robot_config": AgilexDualArmDeltaEefDataConfig(),
    "h10w_robot_config": H10WRealDualArmJointDataConfig(), # H10WDualArmJointDataConfig() # H10WDualArmEefDataConfig()
    "h10w_robot_config_chunk32": H10WRealDualArmJointDataConfigChunk32(),
}
