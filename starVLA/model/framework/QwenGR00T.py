...
from starVLA.utils.mee import simple_mee_loss, adaptive_mee_loss_chunk, adaptive_mee_loss_element
from starVLA.utils.action_noise import apply_action_noise
...
class Qwen_GR00T(baseframework):
    ...
    def forward(
        ...
        **kwargs,
        ...
        return output_dict # {"action_loss": action_loss}
